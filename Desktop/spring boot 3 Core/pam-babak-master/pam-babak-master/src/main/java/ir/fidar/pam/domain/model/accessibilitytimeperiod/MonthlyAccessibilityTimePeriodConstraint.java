...
@Entity
@Table(
   name = "tb_monthly_accessibility_time_period_constraint"
)
public class MonthlyAccessibilityTimePeriodConstraint extends BaseEntity {
   @NotNull(
      message = "null.monthDay"
   )
   @Min(
      value = 1L,
      message = "lt_min.monthDay"
   )
   @Max(
      value = 31L,
      message = "gt_max.monthDay"
   )
