...
@Component
public class MouseClickedFilter implements GuacamoleFilter {
   public GuacamoleInstruction filter(GuacamoleInstruction guacamoleInstruction) throws GuacamoleException {
      return guacamoleInstruction.getOpcode().equalsIgnoreCase("mouse") && !((String)guacamoleInstruction.getArgs().get(2)).equalsIgnoreCase("0")
